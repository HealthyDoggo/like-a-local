...
export function ListItem({ flag, title, onClick }: ListItemProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        {flag && (
          <div className="w-8 h-8 rounded-full flex items-center justify-center text-lg" style={{ backgroundColor: 'var(--app-surface-secondary)' }}>
            {flag}
          </div>
        )}
